...
//			menu.close();
	...
	// 页面状态
	own.pageStatus = {
		notResult: "<div class='not-result c3'><i class='iconfont icon-wodedingdan fz64'></i><br/><br/>暂无数据</div>",
		noNetWork: "<div class='not-result c3'><i class='iconfont icon-wodedingdan fz64'></i><br/><br/>无网络</div>"
	}
